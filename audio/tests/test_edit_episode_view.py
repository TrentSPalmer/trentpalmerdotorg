...
class TestEditEpisodeViewTestCase(TestCase):
    ...
    def test_edit_episode_view_new_title(self):
        ...
        episode_ab = Episode.objects.get(title="The Bee Mark Twain")
        ...
        self.assertNotEquals(
            ...
            f'/episode/{episode_ab.pk}/{episode_a.slug}'
        )
        self.assertEquals(
            response.request['PATH_INFO'],
            f'/episode/{episode_ab.pk}/{episode_ab.slug}'
        )
